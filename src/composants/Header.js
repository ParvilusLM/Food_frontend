                                                ...
                                                <Link className="lien-community" to='/hotline'>
                                                    <div className="wrapper1">
                                                        <div className="wrapper2">
                                                            <picture>
                                                                <img src="/img-downl/hotline.webp" width='100px' height='100px' alt="" className="img-community" loading='lazy' />
                                                            </picture>
                                                        </div>
                                                    </div>
                                                    <h5>Hotline</h5>
                                            ...
                                            <li>
                                                <Link className="lien-community" to=''>
                                                    <div className="wrapper1">
                                                        <div className="wrapper2">
                                                            <picture>
                                                                <img src="/img-downl/contest.webp" width='100px' height='100px' alt="" className="img-community" loading='lazy' />
                                                            </picture>
                                                        </div>
                                                    </div>
                                                    <h5>Contests</h5>
                                            ...
                                            <li>
                                                <Link className="lien-community" to=''>
                                                    <div className="wrapper1">
                                                        <div className="wrapper2">
                                                            <picture>
                                                                <img src="/img-downl/fivetwo.webp" width='100px' height='100px' alt="" className="img-community" loading='lazy' />
                                                            </picture>
                                                        </div>
                                                    </div>
                                                    <h5>Five Two</h5>
