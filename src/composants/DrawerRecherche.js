              ...
              <div className="search-panel__result-img">
                <div className="wrapper-img-1">
                  <div className="wrapper-img-2">
                    <img src="img-downl/insearch_img1.jpg" alt="" className="image" />
                  </div>
                </div>
              </div>
          ...
          <li className="search-panel__results-item">
            <Link to='/' className="search-panel__result">
              <div className="search-panel__result-img">
                <div className="wrapper-img-1">
                  <div className="wrapper-img-2">
                    <img src="img-downl/insearch_img2.jpg" alt="" className="image" />
                  </div>
                </div>
              </div>
              <div className="search-panel__result-body">
          ...
          <li className="search-panel__results-item">
            <Link to='/' className="search-panel__result">
              <div className="search-panel__result-img">
                <div className="wrapper-img-1">
                  <div className="wrapper-img-2">
                    <img src="img-downl/insearch_img3.jpg" alt="" className="image" />
                  </div>
                </div>
              </div>
              <div className="search-panel__result-body">
          ...
          <li className="search-panel__results-item">
            <Link to='/' className="search-panel__result">
              <div className="search-panel__result-img">
                <div className="wrapper-img-1">
                  <div className="wrapper-img-2">
                    <img src="img-downl/insearch_img4.jpg" alt="" className="image" />
                  </div>
                </div>
              </div>
              <div className="search-panel__result-body">
